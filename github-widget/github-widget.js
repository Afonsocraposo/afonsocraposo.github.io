...
(function () {
  ...
  makeWidget = function (payloadData, div) {
    ...
    siteRepoNames = [
      (user + ".github.com").toLowerCase(),
      (user + ".github.io").toLowerCase(),
    ];
    ...
    for (j = 0, len = ref.length; j < len; j++) {
      repo = ref[j];
      if (
        (!opts.forks && repo.fork) ||
        ((ref1 = repo.name.toLowerCase()),
        indexOf.call(siteRepoNames, ref1) >= 0) ||
        !repo.description
      ) {
        continue;
      }
  ...
  get = function (opts) {
    ...
    if (
      opts.multi == null &&
      ((ref2 = tag.toLowerCase()), indexOf.call(get.uniqueTags, ref2) >= 0)
    ) {
  ...
  jsonp = function (opts) {
    ...
    callbackName =
      (ref = opts.callback) != null
        ? ref
        : "_JSONPCallback_" + jsonp.callbackNum++;
